      ...
      <Section>
        <div className="grid gap-lg lg:grid-cols-3">
          <InfoCard icon="contact_page" title="Information for the workflow fit call">
            ...
            <p className="mt-md">
              Interactive answers stay in page memory until you choose to share them. Test requests go to a demonstration endpoint that validates and discards them; no enquiry is delivered or call booked. You can also review and send an email draft to hello@heutrix.com.au. Keep requests general and non-sensitive.
            </p>
          </InfoCard>
