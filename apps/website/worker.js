...
export default {async fetch(request,env){
 ...
 const isAsset=path.startsWith('/assets/')||path.startsWith('/images/')||path.startsWith('/brand/')||path.startsWith('/downloads/')||path==='/favicon.svg'||path==='/favicon.ico'||/^\/heutrix-icon-\d+\.png$/.test(path);
