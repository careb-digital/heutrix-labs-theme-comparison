// Public configuration only. Formspree delivery is defined in formspree.js.
// Legacy hosted-form slots are retained for compatibility, not used for production submission.
export const integrationConfig = {
  email: 'hello@heutrix.com.au',
  consultationFormUrl: '',
  referralFormUrl: '',
  calendarUrl: '',
  submissionMode: 'formspree', // 'mock' is development-only; production always uses Formspree.
};
...
export function enquiryText(enquiry) {
  ...
  return [
    `Hello Heutrix,\n\n${enquiry.kind === 'referral' ? 'I would like to introduce an organisation.' : 'I would like to request a 20-minute introductory conversation.'}`,
