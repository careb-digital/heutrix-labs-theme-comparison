...
VERSION = '2.0 review draft | 13 September 2026'
...
def apply_style(d,short,internal=False):
    ...
    for s in d.sections:
        ...
        s.footer.paragraphs[0].text = 'ABN 64 702 109 662 | ACN 702 109 662 | v2.0 review | Page '
    ...
    d.core_properties.version='2.0 review'
...
generic = [
 ...
 ('Heutrix Client Services Agreement v1.0, dated 1 August 2026','Heutrix Client Services Agreement v2.0 review draft, dated 13 September 2026; replace with exact approved issue version before signature'),
...
def reconcile_native(num,newname):
    ...
    if num in (1,4):
        paragraph_before(anchor,'Heutrix notice address [APPROVE] | formal notice email [APPROVE] | signatory name, role and authority evidence [APPROVE]. Client notice address and authorised signatory [COMPLETE].')
    if num==3:
...
def memo():
    ...
    text_by_index={
      ...
      10:'Background',
      11:'\tThe public website privacy policy and terms are approved and published. The client legal pack has been reconciled as version 2.0 for review. It cannot yet be issued for signature: business, commercial, insurance, data and legal approvals remain open. This memo records preparation status, not legal advice or approval.',
      12:'\tHeutrix Pty Ltd is the documented entity, ABN 64 702 109 662 and ACN 702 109 662. The verified 8 September record states GST non-registration and VIC 3978. Full contractual notice address, signatory authority and notice email remain unconfirmed. Recheck changeable particulars before issue.',
      ...
      28:'Conclusion',29:'Complete document 09 with the full notice address, authorised signatory and notice email; insurance evidence; commercial and delivery rules; client-system/data approvals; and legal review. Record affected-user and owner approval, effective date and exact versions in the legal review register. Then regenerate and check a separate approved issue bundle. Until that decision, use this pack for internal preparation and review only.'
    }
