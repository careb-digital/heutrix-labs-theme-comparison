...
VERSION = '2.2 review draft | 13 September 2026'
...
def apply_style(d,short,internal=False):
    ...
    for s in d.sections:
        ...
        s.footer.paragraphs[0].text = 'ABN 64 702 109 662 | ACN 702 109 662 | v2.2 review | Page '
    ...
    d.core_properties.version='2.2 review'
...
generic = [
 ...
 ('Heutrix Client Services Agreement v1.0, dated 1 August 2026','Heutrix Client Services Agreement v2.2 review draft, dated 13 September 2026; replace with exact approved issue version before signature'),
...
def memo():
    ...
    text_by_index={
      ...
      10:'Background',
      11:'\tThe public website privacy policy and terms are approved and published. The client legal pack has been reconciled as version 2.2 for review. It cannot yet be issued for signature: formal notice email/execution, commercial, insurance, data and legal approvals remain open. This memo records preparation status, not legal advice or approval.',
...
new_document(PACK/"source/10_Pending_Decisions_Register.md", "10_Heutrix_Pending_Decisions_Register.docx", "10", True)

from mark_placeholders import mark_pack
mark_pack(PACK)


# Apply the current brand after body/placeholder processing.
import runpy, sys
