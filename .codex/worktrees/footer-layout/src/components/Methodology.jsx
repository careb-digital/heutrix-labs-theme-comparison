...
export default function Methodology() {
  ...
  const methodSteps = [
    { title: "Diagnose", desc: "Understand core problems and find workflow gaps." },
    { title: "Triage", desc: "Pinpoint and prioritise crucial bottlenecks." },
    { title: "Build", desc: "Implement and test the simplest suitable workflow improvement." },
  ...
  return (
    <div className="bg-surface relative" id="methodology">
      ...
      {/* Section 2: What Heutrix does */}
      <StickySection 
        title="What Heutrix does"
        bgColor="bg-primary"
        description="Heutrix helps care-related service providers improve the internal systems that sit around client care and service delivery. We are not here to replace your core practice, client or case management software."
      >
      ...
      <section className="py-xxl px-lg max-w-5xl mx-auto space-y-[15vh] relative z-20 bg-surface my-[10vh]">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true, amount: 0.5 }}>
          <p className="font-headline-md text-headline-md text-on-surface-variant font-normal">
            Heutrix starts by understanding how your work actually happens, then recommends practical improvements that are safe, maintainable and useful in daily operations.
          </p>
        </motion.div>
