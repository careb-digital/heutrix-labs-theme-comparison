              ...
              <div className="flex items-start gap-md">
                ...
                <div>
                  ...
                  <p className="font-body-sm text-body-sm">
                    Heutrix provides workflow improvement, safe AI support, practice visibility builds and operational systems. We do **NOT** provide clinical advice, medical advice, legal advice, financial advice, regulatory advice, official audit services, NDIS registration readiness, or compliance gap assessments.
                  </p>
                </div>
              </div>
            </div>
