...
const pressurePoints = [
  ...
  },
  {
    ...
    href: '/resources/workflow-bottleneck-scorecard?workflow=onboarding',
  ...
  },
  {
    ...
    href: '/resources/workflow-bottleneck-scorecard?workflow=action-tracking',
    action: 'Start the Scorecard',
  },
  {
  ...
  },
  {
    ...
    href: '/resources/workflow-bottleneck-scorecard?workflow=reporting',
    action: 'Start the Scorecard',
    note: 'Operational reporting is preselected. You can change it in the assessment.',
  },
  {
...
function CardContent({point, index, measuring = false}) {
  return <>
    ...
    {point.note && <p className="pressure-context">{point.note}</p>}
...
export default function WorkflowPressurePoints() {
  ...
  // The server and first browser render must agree. Start without motion, then
  // read the preference after hydration and keep listening for system changes.
  ...
  return <section id="problem" ref={sectionRef} className="pressure-points" aria-labelledby="pressure-title">
    <div className="pressure-layout r-container">
      <div className="pressure-intro">
        ...
        <a className="pressure-services" href="/services">Explore Services <ArrowUpRight size={18} aria-hidden="true"/></a>
      </div>
