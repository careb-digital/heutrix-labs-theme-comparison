import {tools as interactiveTools} from './leadMagnets/model.js';
export const routes = [
  ...interactiveTools.map(tool => ({path: `/resources/${tool.id}`, label: tool.title, seoTitle: `${tool.title} | Heutrix`, metaDescription: tool.intro})),
  {path: '/refer', label: 'Refer an organisation', seoTitle: 'Refer an Organisation | Heutrix', metaDescription: 'Introduce an organisation to Heutrix with permission.'},
 {path:'/case-studies',label:'Workflow examples',seoTitle:'Workflow Examples | Heutrix',metaDescription:'Explore illustrative approaches to worker onboarding, payment reminders and action follow-up for disability providers.'},
  {
    path: '/',
    label: 'Home',
    seoTitle: 'Heutrix | Workflow Improvement for Disability Providers',
    metaDescription:
      'Heutrix helps Australian disability service providers, including NDIS providers, reduce repetitive administration, clarify handovers and improve workflows around existing systems.'
  },
  {
    path: '/services',
    label: 'Services',
    seoTitle: 'Diagnostics, Workflow Transformation and AI Guardrails | Heutrix',
    metaDescription:
  ...
  },
  {
    path: '/allied-health',
    label: 'Allied Health',
    seoTitle: 'Workflow Improvement for Allied Health Practices | Heutrix',
    metaDescription:
      'Heutrix helps Australian allied health practices improve enquiry and referral tracking, document collection, reporting, onboarding, handovers and management visibility.'
  },
  {
    path: '/disability-providers',
    label: 'Disability Providers',
    seoTitle: 'Workflow Improvement for Disability Support Providers | Heutrix',
    metaDescription:
      'Heutrix helps Australian disability support providers improve intake, service agreement tracking, document collection, incidents, complaints, evidence, onboarding and handovers.'
  },
  {
    path: '/ai-guardrails',
    label: 'AI Guardrails',
    seoTitle: 'Heutrix AI Guardrails for Disability Providers | Heutrix',
    metaDescription:
  ...
  },
  {
    path: '/resources',
    label: 'Resources',
    seoTitle: 'Free Workflow Tools and AI Guardrails Templates | Heutrix',
    metaDescription:
      'Download practical, ungated workflow prioritisation, enquiry-to-service-start visibility and AI guardrails starter resources from Heutrix.'
  },
  {
    path: '/about',
    label: 'About',
    seoTitle: 'About Heutrix',
    metaDescription:
  ...
  },
  {
    path: '/contact',
    label: 'Contact',
    seoTitle: 'Start a 20-Minute Introductory Conversation | Heutrix',
    metaDescription:
      'Request a 20-minute introductory conversation about one recurring operational problem. No sensitive information is needed.'
  },
  {
    path: '/privacy-and-data-handling',
    label: 'Privacy Policy and Data Handling',
    seoTitle: 'Privacy Policy and Data Handling | Heutrix',
    metaDescription:
      'How Heutrix Pty Ltd handles website enquiries, referrals, resource answers, service providers, overseas processing, retention and privacy requests.'
  },
  {
    path: '/terms-of-use',
    label: 'Terms of Use',
    seoTitle: 'Terms of Use | Heutrix',
    metaDescription:
      'Terms for using the Heutrix website, including general-information limits, service boundaries, project scopes and client responsibilities.'
  },
  {
    path: '/website-disclaimer',
    label: 'Website Disclaimer',
    seoTitle: 'Website Disclaimer | Heutrix',
    metaDescription:
      'Website disclaimer covering Heutrix operational services, professional-advice limits, AI use, privacy and client responsibilities.'
  }
];
...
export const ctas = {
  fitCall: { label: 'Talk to Heutrix', href: '/contact' },
  scorecard: { label: 'Start the Scorecard', href: '/resources/workflow-bottleneck-scorecard' },
  process: { label: 'See How It Works', href: '/#heutrix-method' },
  rightFit: { label: 'Find the Right Fit', href: '/contact?service=not-sure' },
  services: { label: 'Explore Services', href: '/services' },
  diagnostic: { label: 'Discuss Diagnostics', href: '/contact?service=heutrix-diagnostics' },
  workflow: { label: 'Discuss Transformations', href: '/contact?service=heutrix-workflow-transformation' },
  ai: { label: 'Discuss AI Guardrails', href: '/contact?service=heutrix-ai-guardrails' }
};
...
export const resources = [
  {
    ...
    icon: 'score',
    title: 'Workflow Bottleneck Scorecard',
    audience: 'Best first resource for disability-provider operations leaders',
    summary:
      'Assess one workflow online: 10 required questions across 3 steps, with an immediate result. The separate Excel workbook compares up to 12 workflows.',
    outcome:
      'See the signals from your answers, evidence strength, feasibility and control status, with practical actions you can save without a call.',
...
export const homeServices = [
  {
    ...
    cta: { label: 'View Diagnostics', href: '/services#heutrix-diagnostics' }
  },
  {
    ...
    cta: { label: 'View Transformations', href: '/services#heutrix-workflow-transformation' }
  },
  {
    ...
    cta: { label: 'View AI Guardrails', href: '/services#heutrix-ai-guardrails' }
  }
];
...
export const alliedHealthContent = {
  ...
  boundary:
    'Heutrix supports operational workflows around service delivery. Clinical decisions, legal obligations, professional standards and regulatory approvals remain the responsibility of the practice and its qualified advisers.',
...
export const disabilityContent = {
  ...
  startingNote:
    'Choose Heutrix Diagnostics when the priority is unclear, Heutrix Workflow Transformation when one workflow is ready to improve, or Heutrix AI Guardrails when staff need practical rules for responsible AI use.',
  boundary:
    'Heutrix supports operational workflow systems. It does not provide NDIS registration readiness, mock audits, audit certification, legal advice, clinical advice or regulatory approval. Each provider remains responsible for approving, applying and maintaining its own processes and obligations.',
...
export const faqs = [
  {question: 'What does the online Scorecard involve?', answer: 'Assess one workflow with 10 required questions across 3 steps: choose the workflow, understand the friction, then check readiness. See your result immediately and save practical actions without a call or email address. The separate Excel workbook compares up to 12 workflows.'},
  {
    question: 'What does Heutrix do?',
    answer:
      'Heutrix offers three practical services: Heutrix Diagnostics to identify and prioritise operational problems, Heutrix Workflow Transformation to redesign and implement one bounded workflow, and Heutrix AI Guardrails to establish responsible workplace AI rules. We focus on the operational systems around care and service delivery, not clinical decision-making.'
  },
  {
    question: 'Who does Heutrix work with?',
    answer:
  ...
  },
  {
    ...
    answer:
      'No. Heutrix does not replace your core practice, client or case management system. We help improve the operational workflows around your existing tools where appropriate.'
  },
  {
  ...
  },
  {
    ...
    answer: 'No. Heutrix does not provide legal advice.'
  },
  {
    question: 'Do you provide clinical advice?',
    answer: 'No. Heutrix does not provide clinical advice.'
  },
  {
    question: 'Do you promise compliance outcomes?',
    answer:
      'No. Heutrix does not promise compliance outcomes, audit success, registration outcomes or regulatory approval. Our work can support better operational systems, but the client remains responsible for reviewing, approving and maintaining their own processes.'
  },
  {
    question: 'Do you provide NDIS registration readiness or mock audits?',
    answer:
      'No. Heutrix does not provide NDIS registration readiness, mock audits, official audit certification or regulatory approval. Heutrix may support operational workflow tools for disability support providers and other regulated providers where the work is within scope.'
  },
  {
...
export const footerCopy = {
  summary:
    'Heutrix helps Australian disability support providers—and selected allied health practices—diagnose operational friction, transform one bounded workflow and put practical AI guardrails in place.',
  boundary:
    'Heutrix Diagnostics, Heutrix Workflow Transformation and Heutrix AI Guardrails are operational services. Heutrix does not provide official audit certification, legal advice, clinical advice, NDIS registration readiness, mock audits or regulatory approval.'
};
