...
export const routes = [
  ...
  {path: '/refer', label: 'Refer an organisation', seoTitle: 'Refer an Organisation | Heutrix Labs', metaDescription: 'Introduce an organisation with a recurring operational workflow problem to Heutrix. Prepare and review a business referral.'},
  {
    path: '/',
    label: 'Home',
  ...
  },
  {
    ...
    metaDescription:
      'Try interactive workflow prioritisation, enquiry-to-service-start planning and AI guardrails checks. Save a practical action plan or discuss your result with Heutrix.'
  },
  {
    path: '/about',
    label: 'About',
