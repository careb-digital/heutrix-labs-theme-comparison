# Current CTA and enquiry behaviour — 8 September 2026

The canonical original-theme site uses **Get the Scorecard**, **Take the Assessment**, **Get the Guide** and **Get the Template**. General conversation links use **Talk to Heutrix**; assessment results use **Discuss Diagnostics**, **Discuss Transformations** or **Discuss AI Guard** when a service is suggested.

The current enquiry flow uses **Review My Enquiry** (or **Review My Referral**) followed by **Open Email Draft**. It does not send automatically. The Google connection remains reserved as documented in GOOGLE-ENQUIRIES.md. Use **Send Enquiry** only when a connected form sends the request, **Send My Scorecard** only for actual scorecard delivery, and **Choose a Time** for a connected calendar.
