...
export const routes = [
  ...interactiveTools.map(tool => ({path: `/resources/${tool.id}`, label: tool.title, seoTitle: `${tool.title} | Heutrix Labs`, metaDescription: tool.intro})),
  {path: '/refer', label: 'Refer an organisation', seoTitle: 'Refer an Organisation | Heutrix Labs', metaDescription: 'Introduce an organisation to Heutrix with permission.'},
 {path:'/case-studies',label:'Workflow examples',seoTitle:'Workflow Examples | Heutrix Labs',metaDescription:'Explore illustrative approaches to worker onboarding, payment reminders and action follow-up for disability providers.'},
  {
    path: '/',
    label: 'Home',
    seoTitle: 'Heutrix Labs | Workflow Improvement for Disability Providers',
    metaDescription:
      'Heutrix Labs helps Australian disability service providers, including NDIS providers, reduce repetitive administration, clarify handovers and improve workflows around existing systems.'
  },
  {
    path: '/services',
    label: 'Services',
    seoTitle: 'Diagnostics, Workflow Transformation and AI Guard | Heutrix Labs',
    metaDescription:
      'Compare Heutrix Diagnostics, Workflow Transformation and AI Guard for Australian disability support providers and allied health practices.'
  },
  {
    path: '/allied-health',
    label: 'Allied Health',
  ...
  },
  {
    path: '/ai-guardrails',
    label: 'AI Guard',
    seoTitle: 'Heutrix AI Guard for Disability Providers | Heutrix Labs',
    metaDescription:
      'Heutrix AI Guard helps Australian disability support providers and allied health practices define approved AI uses, information boundaries, accountable review and staff guidance.'
  },
  {
    path: '/resources',
    label: 'Resources',
  ...
  },
  {
    ...
    metaDescription:
      'Answers about Heutrix Diagnostics, Workflow Transformation, AI Guard, project timing, free resources, information handling and service boundaries.'
  },
  {
    path: '/contact',
    label: 'Contact',
    seoTitle: 'Start a 20-Minute Introductory Conversation | Heutrix Labs',
    metaDescription:
...
export const ctas = {
  ...
  scorecard: { label: 'Get the Scorecard', href: '/resources/workflow-bottleneck-scorecard' },
  ...
  ai: { label: 'Discuss AI Guard', href: '/contact?service=heutrix-ai-guardrails' }
};
...
export const resources = [
  ...
  },
  {
    ...
    bridge:
      'If use is already widespread or the rules are difficult to apply in practice, Heutrix AI Guard may help turn the starter controls into an organisation-specific operating system.'
  }
];
...
export const homeServices = [
  ...
  },
  {
    ...
    cta: { label: 'View AI Guard', href: '/services#heutrix-ai-guardrails' }
  }
];
...
export const alliedHealthContent = {
  ...
  startingPoints: ['Heutrix Diagnostics', 'Heutrix Workflow Transformation', 'Heutrix AI Guard'],
  startingNote:
    'Choose Heutrix Diagnostics when the priority is unclear, Heutrix Workflow Transformation when one workflow is ready to improve, or Heutrix AI Guard when staff need practical rules for responsible AI use.',
  boundary:
...
export const faqs = [
  {
    ...
    answer:
      'Heutrix Labs offers three practical services: Heutrix Diagnostics to identify and prioritise operational problems, Heutrix Workflow Transformation to redesign and implement one bounded workflow, and Heutrix AI Guard to establish responsible workplace AI rules. We focus on the operational systems around care and service delivery, not clinical decision-making.'
  },
  {
  ...
  },
  {
    ...
    answer:
      'Choose Heutrix Diagnostics when the priority, workflow boundary, baseline or feasible solution is unclear. Choose Heutrix Workflow Transformation when one workflow, owner, users and desired result can be bounded and tested. Choose Heutrix AI Guard when workplace AI needs approved uses, information boundaries, accountable review, escalation and staff guidance. You do not need to select a product before the introductory conversation.'
  },
  {
...
export const footerCopy = {
  ...
  boundary:
    'Heutrix Diagnostics, Heutrix Workflow Transformation and Heutrix AI Guard are operational services. Heutrix Labs does not provide official audit certification, legal advice, clinical advice, NDIS registration readiness, mock audits or regulatory approval.'
};
