...
routes.push(...caseStudies.map(c => ({path:'/case-studies/'+c.slug,label:c.title,seoTitle:c.title+' | Heutrix Labs',metaDescription:'Illustrative provider workflow. '+c.metric})));
...
function setMeta(page) {
  ...
  const canonicalUrl = `https://heutrix-labs-original-theme.janith.workers.dev${normalizePath(window.location.pathname) === '/' ? '/' : normalizePath(window.location.pathname)}`;
...
function PageRenderer({ path, search }) {
  if (path.startsWith('/resources/') && knownPaths.has(path)) return <InteractiveTool key={path} id={path.split('/')[2]} />;
  ...
  return (
    <aside className="rounded-xl border border-outline-variant bg-white p-lg shadow-sm">
      ...
      <p className="font-body-sm text-body-sm text-on-surface-variant">
        Heutrix Diagnostics, Workflow Transformation and AI Guard support internal operations. Legal, clinical,
  ...
  return (
    ...
    >
      ...
      <div className="mb-lg flex flex-col gap-sm sm:flex-row sm:flex-wrap">
        <ButtonLink href={`/resources/${resource.id}`}>{resource.id === 'workflow-bottleneck-scorecard' ? 'Get the Scorecard' : 'Take the Assessment'}</ButtonLink>
    ...
    <>
      ...
      >
        ...
        <p>
          ...
          and implements one bounded workflow. Heutrix AI Guard gives staff practical boundaries for responsible AI use.
        </p>
        <p>
...
function AiGuardrailsPage() {
  return (
    <>
      <PageHero
        title="Heutrix AI Guard for responsible day-to-day use."
      ...
      <Section className="bg-surface-container-low">
        <div className="grid gap-xl lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <SectionIntro title="What Heutrix AI Guard helps with">
            <p>
      ...
      <Section>
        <div className="grid gap-xl lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <InfoCard icon="rule" title="What is included">
            ...
            <p className="mt-md">Heutrix AI Guard provides operational guidance and does not replace legal, privacy, clinical or professional advice.</p>
          </InfoCard>
        </div>
      </Section>
  ...
  return (
    <>
      ...
      <Section>
        <div className="grid gap-lg lg:grid-cols-3">
          <InfoCard icon="no_accounts" title="No email gate">
            <p>
              Downloads are provided directly. If you later request a introductory conversation, that separate request follows the lead
      ...
      <CtaSection
        ...
        body="Bring a high-level, non-sensitive description to a 20-minute, no-obligation introductory conversation. The outcome may be Diagnostics, Workflow Transformation, AI Guard, more evidence gathering or no project."
  ...
  return (
    <>
      <PageHero title="Frequently asked questions" compact>
        <p>
          Practical answers about Heutrix Diagnostics, Workflow Transformation, AI Guard, timing, resources, privacy and the
      ...
      <Section>
        <div className="grid gap-lg lg:grid-cols-3">
          <InfoCard icon="contact_page" title="Information for the introductory conversation">
            ...
            <p className="mt-md">
              Interactive answers stay in page memory until you choose to share them. The enquiry form prepares an email draft for you to review and send to hello@heutrix.com.au. Opening a draft does not send it or book a conversation. Keep requests general and non-sensitive.
            </p>
          </InfoCard>
          <InfoCard icon="download" title="Resource downloads">
            <p>
              ...
              permission. If you separately request a introductory conversation from the resources page, the request may record that
      ...
      <Section className="bg-surface-container-low">
        <div className="grid gap-lg md:grid-cols-2">
          <InfoCard icon="rule" title="Service boundary">
            <p className="mb-md">Heutrix Labs provides Diagnostics, Workflow Transformation and AI Guard.</p>
            <BulletList
              tone="boundary"
              items={[
                'Legal advice',
          ...
          <InfoCard icon="schedule" title="Introductory conversation">
            ...
            <p className="mt-md">
              A request is not a confirmed booking. The enquiry page currently prepares an email draft;
              review and send it from your email app. Opening the draft does not send it.
            </p>
          </InfoCard>
          ...
          <InfoCard icon="gavel" title="Website operator">
            <p>
              This website is operated by Heutrix Pty Ltd (ABN 64 702 109 662), trading as Heutrix Labs.
              For questions about website use, contact hello@heutrix.com.au.
            </p>
          </InfoCard>
        </div>
      </Section>
  ...
  return (
    <>
      <PageHero title="Website disclaimer" compact>
        <p>
          This website describes Heutrix Diagnostics, Heutrix Workflow Transformation and Heutrix AI Guard for
        ...
        <div className="mx-auto max-w-4xl rounded-xl border border-outline-variant bg-white p-xl shadow-sm">
          ...
          <div className="mt-lg grid gap-md md:grid-cols-2">
            ...
            <InfoCard icon="smart_toy" title="AI disclaimer">
              <p>
                Heutrix AI Guard focuses on internal operating rules, approved use cases, information boundaries
            ...
            <InfoCard icon="gavel" title="Website operator">
              <p>
                Heutrix Labs is operated by Heutrix Pty Ltd (ABN 64 702 109 662).
