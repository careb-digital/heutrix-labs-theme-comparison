      ...
      <div className="mx-auto max-w-container-max">
        <div className="mb-xxl grid gap-xl lg:grid-cols-[1fr_1.2fr_0.8fr]">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-lg">
            ...
            <p className="mt-lg mb-sm font-body-sm text-body-sm text-inverse-on-surface">Not ready to talk? Find a workflow worth improving with our free scorecard.</p>
            <a className="inline-flex w-full items-center justify-center rounded-xl border border-white/40 px-lg py-md font-label-md text-white transition-opacity hover:opacity-95" href={ctas.scorecard.href}>{ctas.scorecard.label}</a>
          </div>
        </div>
