...
// Google Apps Script delivery will connect through the Worker; keep its URL and secret server-side.
export const integrationConfig = {
  email: 'hello@heutrix.com.au',
  consultationFormUrl: '',
  referralFormUrl: '',
  calendarUrl: '',
  submissionMode: 'email', // 'mock' or 'email'; hosted form URLs take precedence.
};
